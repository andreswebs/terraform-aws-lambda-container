...
| <a name="input_lambda_name_prefix"></a> [lambda\_name\_prefix](#input\_lambda\_name\_prefix) | A prefix for the Lambda name, will be prepended to a random ID | `string` | `"function"` | no |
...
| <a name="input_lambda_source_path"></a> [lambda\_source\_path](#input\_lambda\_source\_path) | Path to the Lambda source code | `string` | n/a | yes |
